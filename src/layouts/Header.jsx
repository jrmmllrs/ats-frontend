...
export default function Header({ onSelectView, onToggleSidebar, onToggleATSHealthcheck, selectedView }) {
  ...
  const canViewNotifications = hasFeature("Notification"); // Check if the user has the "Notification" feature
  ...
  return (
    <header className="top-0 flex items-center justify-between py-4">
      ...
      <div className="flex items-center gap-4">
        {canViewNotifications && ( // Conditionally render the notification bell
          <button
